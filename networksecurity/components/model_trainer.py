...
class ModelTrainer:
    ...
    def track_mlflow(self, best_model,classificationmetric):
        with mlflow.start_run():
            f1_score=classificationmetric.model_f1_score
            precision_score = classificationmetric.model_precision
            recall_score = classificationmetric.model_recall
    ...
    def train_model(self,x_train,y_train,x_test,y_test):
        ...
        #track the experiments and metrics with mlflow 
        ...
        Network_Security_Model = NetworkSecurityModel(preprocessing_object=preprocessor, trained_model_object=best_model)
